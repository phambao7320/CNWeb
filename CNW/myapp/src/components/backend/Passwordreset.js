...
export default function ResetPassword() {
    ...
    const [passrs, setPassrs]      = useState('') ;
    ...
    const handCheck = () => {
      ...
      .then((result) => {
        ...
        if ( result.message != "Reset Password successfully"){
          window.alert("Reset Password thất bại") ;
        }
        else{
          window.alert("Reset Password thành công") ;
          history.push('/login')
        }
      },
        () => {
    ...
    const onChangePassrs = (e) => {
      setPassrs(e.target.value) ;
    }
                  ...
                  <div className="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div className="card-body">
                      ...
                      <form>
                        ...
                        <div className="form-floating mb-3">
                          <input className="form-control" type="email" onChange={onChangeEmailrs}     />
                          <label htmlFor="inputEmail">Email address</label>
                        </div>
                        <div className="form-floating mb-3">
                          <input className="form-control" type="password" onChange={onChangePassrs}   />
                          <label htmlFor="inputEmail">Password Reset</label>
                        </div>
                    ...
                    <div className="card-footer text-center py-3">
                       <div className="d-flex align-items-center justify-content-between mt-4 mb-0">
                          ...
                          <div className="btn btn-primary" onClick = {handCheck}>Reset Password</div>
                        </div>
                    </div>
                  </div>
                </div>
